...
* Technical Program Committee (TPC) Member of IEEE [ICC 2025](https://icc2025.ieee-icc.org/), [ICC 2026](https://icc2026.ieee-icc.org/)
* **Journal Article Reviewer** IEEE Transactions on Wireless Communications (TWC), IEEE Transactions on Communications (TCOM), IEEE Wireless Communications (WCM), IEEE Internet of Things Journal (IoT), IEEE Transactions on Machine Learning in Communications and Networking (TMLCN), Scientific Reports
* **Conference Paper Reviewer** IEEE Conference on Computer Communications (INFOCOM), IEEE International Conference on Communications (ICC), USENIX Conference on Security Symposium (Security)
